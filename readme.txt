...
**Welcome Dashboard** allows you to replace the default WordPress welcome panel with any page you create using your favorite page builder - Elementor, Gutenberg, Classic Editor, or any other.
...
* **Page Builder Compatible** - Works with Elementor, Gutenberg blocks, Classic Editor, and more
...
2. Go to **Settings → Welcome Dashboard**
...
3. Go to **Settings → Welcome Dashboard** to configure
4. Create a page with any page builder and assign it to user roles

== Frequently Asked Questions ==

= Does this plugin require Elementor? =

No! While Elementor is fully supported, you can use any page builder or the default WordPress editor (Gutenberg or Classic Editor).
...
1. Settings page - Clean, modern interface
2. Role-based page assignment
3. Custom dashboard welcome panel in action
...
= 1.0.0 =
Initial release of Welcome Dashboard.
